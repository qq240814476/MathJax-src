 ...
 *  The TeXFont class
 */
export class CommonStixFont extends FontData {
     ...
     */
    protected static defaultSizeVariants = ['normal', '-smallop', '-largeop', '-size3', '-size4', '-stretchy'];
     ...
     * @return {CharData}   The data for the character to be used for stretchy delimiters
     */
